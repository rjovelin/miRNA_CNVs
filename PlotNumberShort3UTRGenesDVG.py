...
# - [species/human]: plot the number of short genes for each species (use DVG-2015 for human)
#                    or for human only using each release of the DGV
...
if species == 'species':
    # count the number of short 3'UTR genes in each species
